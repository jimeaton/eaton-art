...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-YVN5B7CW.js")
});
...
var ChevronWrapper = ct(Box)`
  margin-left: auto;
`;
var CrossDatasetReferencesDetails = ct.details`
  flex: none;
...
`;
var CrossDatasetReferencesSummary = ct.summary`
  list-style: none;
...
var DialogBody$1 = ct(Box)`
  box-sizing: border-box;
`;
var LoadingContainer = ct(Flex).attrs({
  align: "center",
  direction: "column",
  justify: "center"
})`
...
var TitleTextSkeleton = ct(TextSkeleton)`
  width: 66%;
  max-width: 175px;
`;
var TitleText = ct(Text)`
  cursor: default;
  outline: none;
`;
...
var VersionModeHeaderLayout = ct.header`
  display: grid;
  grid-area: header;
  grid-template-columns: 1fr min-content 1fr;
  border-block-end: 1px solid var(--card-border-color);
`;
var VersionModeHeaderLayoutSection = ct.div`
  display: flex;
...
`;
var DiffViewPaneLayout = ct(Card)`
  position: relative;
  grid-area: var(--grid-area);
`;
var Container2 = ct(Container)`
  width: auto;
`;
...
var JSONInspectorWrapper = ct.div(({
  theme
}) => {
  const {
    color,
...
var DocumentBox = ct(Box)({
  position: "relative"
});
var Scroller$4 = ct(ScrollContainer)(({
  $disabled
}) => $disabled ? {
  height: "100%"
} : st`
...
var HorizontalScroller = ct(Card)((props) => {
...
var FlipIcon = ct(ChevronLeftIcon)`
...
var StackWrapper = ct(Stack)`
  max-width: 200px;
`;
var ListWrapper = ct(Flex)`
...
var NameSkeleton = ct(Skeleton)((props) => {
  const theme = getTheme_v2(props.theme);
  return st`
    width: 6ch;
...
var StyledMotionPath = ct(motion.path)`
...
var StyledChangeConnectorRoot = ct(ChangeConnectorRoot)`
  flex: 1;
  display: flex;
...
`;
var AnimatedSpinnerIcon = ct(SpinnerIcon)`
  animation: ${rotate} 500ms linear infinite;
`;
var SubtleSpinnerIcon = ct(SpinnerIcon)`
  animation: ${rotate} 1500ms linear infinite;
  opacity: 0.4;
`;
var DelayedSubtleSpinnerIcon = ct(SpinnerIcon)`
  animation:
...
`;
var PinnedDataCell = ct(DataCell)`
  position: sticky;
  z-index: 2;
`;
...
`;
var PinnedHeader = ct(Header)`
  position: sticky;
  z-index: 2;
`;
var HoverMenu = ct.div`
  visibility: hidden;
...
var PaneContainer$1 = ct(Flex)`
  height: 100%;
`;
var TableContainer = ct.div`
...
var Scroller$3 = ct(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$2 = ct(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$1 = ct(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller = ct(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-QHJBXCYB.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-NULPTLOW.js.map
